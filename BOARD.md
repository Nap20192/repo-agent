...
| 37 | wiring: runner builds the registry + Domain/Knowledge tools into specialists; live eval per specialist; reviewers; GATE 2 | main + live-eval-specialists | merged (reviewed: code 2 high + 2 medium fixed, security 1 high + 4 medium fixed), awaiting GATE 2 | scanner/app/runner.py, scanner/adapter/tools.py, scanner/adapter/store.py, tests/test_runner_wiring.py, eval/agents.py | pytest green; reviews clean |
