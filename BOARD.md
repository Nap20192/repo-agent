...
| 44 | Shannon-style discovery: Planner (coverage guarantee, adversarial share), Triage sweep → specialist audit, ported hunting checklists, existence-check gate for synthetic anchors | dev-team | review (f8c317c planner, 41e38ec triage, 0bdf657 checklists) | scanner/app/instructions.py, reconcile.py, pipeline_v2.py, tools/gates.py, skills | NodeGoat re-run recalls ≥5 of the known code vulns |
