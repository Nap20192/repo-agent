"""Static scanners → Anchors: gosec, semgrep, osv-scanner, gitleaks run on the host; SARIF/OSV/gitleaks parsing,
secret redaction and duplicate merging. File walking lives in `fs`, text detectors in `entrypoints`.

Ported from git-agent3 internal/adapter/{static,secrets}.
"""
