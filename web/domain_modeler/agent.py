"""`adk web web`: the `domain_modeler` agent alone, wired like in a full run (scanner.app.runner.standalone) — chat with it,
...
lands in .state/state.db. Scaffolded with `adk create web/domain_modeler` (card 46).
"""
