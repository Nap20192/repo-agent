"""`adk web web`: the `authz` agent alone, wired like in a full run (scanner.app.runner.standalone) — chat with it,
...
lands in .state/state.db. Scaffolded with `adk create web/authz` (card 46).
"""
