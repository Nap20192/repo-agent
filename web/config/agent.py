"""`adk web web`: the `config` agent alone, wired like in a full run (scanner.app.runner.standalone) — chat with it,
...
lands in .state/state.db. Scaffolded with `adk create web/config` (card 46).
"""
