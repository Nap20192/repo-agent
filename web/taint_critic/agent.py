"""`adk web web`: the `taint_critic` agent alone, wired like in a full run (scanner.app.runner.standalone) — chat with it,
...
lands in .state/state.db. Scaffolded with `adk create web/taint_critic` (card 46).
"""
