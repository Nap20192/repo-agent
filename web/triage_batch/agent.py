"""`adk web web`: the `triage_batch` agent alone, wired like in a full run (scanner.app.runner.standalone) — chat with it,
...
lands in .state/state.db. Scaffolded with `adk create web/triage_batch` (card 46).
"""
